...
namespace CircularProgressBar.Drawables
{
    public class CircularProgressBarDrawable : BindableObject, IDrawable
    {
        ...
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            canvas.DrawString($"{Progress}", x, verticalPosition-5, effectiveSize, effectiveSize / 4, HorizontalAlignment.Center, VerticalAlignment.Center);
            canvas.FontSize = fontSize / 2;
            canvas.DrawString("\nSeconds", x, verticalPosition+5, effectiveSize, effectiveSize / 4, HorizontalAlignment.Center, VerticalAlignment.Center);
        }
